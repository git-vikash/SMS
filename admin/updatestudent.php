...
<html>
    ...
    <body >
    <center> <h1><?php echo $_SESSION['admin_name']; ?>! Update Student Details</h1></center>
    <form method="POST" enctype="multipart/form-data" action="updatestudent.php" style="padding-top: 40px;padding-bottom: 40px; width: 400px;background-color:powderblue;color: blue; border: 1px solid grey;margin-left: auto;margin-right: auto;">
...
<td ><center><a href="edit.php?sid=<?php echo $data['id'];?>" style="text-decoration: none;">Edit</a></center></td>
    </tr>
        <?php
    }
}
